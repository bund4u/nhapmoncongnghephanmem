            ...
            <div class="card border-0 shadow rounded-3 my-5">
              <div class="card-body p-4 p-sm-5">
                ...
                <form>
                  ...
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="floatingPassword" placeholder="callnumer">
                    <label for="floatingPassword">Số điện thoại</label>
                  </div>
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="floatingPassword" placeholder="address">
                  ...
                  <div class="d-grid btn-login">
                    <button class="btn btn-outline-primary btn-login text-uppercase fw-bold" type="submit">Tạo tài khoản</button>
                  </div>
